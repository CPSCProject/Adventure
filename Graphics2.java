...
public class Graphics2 extends JFrame implements ActionListener
...
JButton getclue;
JTextField input;
private String input3 = "In this adventure game, you must obtain keys to escape from this room. as you play this game. \nyou will see that each room contains different games that requires different skills to complete. \nTimer will be set based on the diffculty that you choose. you will lose lives if the timer is set to zero." ;
private String inputKitchen = "Welcome to library. This room will give you few questions that requries your knowledge and wits. \nQuestions could be a puzzle, a phrase, or combinations of words.\n After finshing this game, you will obtain a key to go to the next room. " ;
...
//Add actionlisnter to JButton--------------------------------------------------
 ...
 getclue.addActionListener(new ButtonListener());
...
// mainframe set up-------------------------------------------------------------
  ...
  public void actionPerformed(ActionEvent e)
  {
      ...
      if(e.getActionCommand() == "Get Hint") {
          JOptionPane.showMessageDialog(null, "Hello, please type anything for hints");
