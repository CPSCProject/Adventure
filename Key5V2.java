...
while (gameStart == false)
{
  ...
  JOptionPane.showMessageDialog(null, str_roominfo);
  String userchoice = printMainMenu();
  if (userchoice.equals("1) Investigate the table"))
  {
    while (key5 == false)
      {
          JOptionPane.showMessageDialog(null, str_switchTable_descrip);
          JOptionPane.showMessageDialog(null, curr_d_colour);
          printTableMenu();
          getColour();
          JOptionPane.showMessageDialog(null, new_d_colour);
          key5 = sw_Room();
          tryDoor();
        }
      JOptionPane.showMessageDialog(null, switchTable_set);
    }
    ...
    else if (userchoice.equals("2) Try to open the door"))
        {
          if (key5 == false)
          {
            JOptionPane.showMessageDialog(null, door_locked);
          }
          else
          {
            JOptionPane.showMessageDialog(null, door_unlocked);
            gameStart = true;
          }
        }
      }
